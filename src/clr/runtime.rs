...
impl<'a> RustClrRuntime<'a> {
    /// Creates a new [`RustClrRuntime`] instance.
    ...
    ///
    /// This function:
    /// - Loads the desired .NET runtime version.
    /// - Sets up the assembly identity.
    /// - Starts the CLR if needed.
    /// - Creates or attaches to an AppDomain.
    ///
    /// After calling this, the CLR is fully ready to load and run the assembly.
